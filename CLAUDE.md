...
- **Duas telas do pregão, UM motor** (desde 24/09): a **"show"** é a **padrão** (`/`, `leilao_show.html` +
  `palco_show.css` + `palco_show.js`) e a clássica ficou de **backup** (`/classico/`, `leilao.html`;
  `/nova/` redireciona para `/`). Lance, chat,
